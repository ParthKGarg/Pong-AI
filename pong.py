...
class Pong:
    def __init__(self) -> None:
        ...
        self.font = pygame.font.SysFont("comicsans", 25, True)
    ...
    def redrawGameWindow(self):
        ...
        text1 = self.font.render(f"{self.p1.score}", 1, WHITE)
        text2 = self.font.render(f"{self.p2.score}", 1, WHITE)
        text1Cords = (350, 0)
        text2Cords = (450 - text2.get_width(), 0)

        self.window.blit(text1, text1Cords)
        self.window.blit(text2, text2Cords)
